...
late Future<List<Governorate>> dropDownLocations;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late String selectedTreatmentName = '';
  ...
  @override
  void initState() {
    dropDownLocations = Provider.of<LocationController>(context, listen: false)
        .getLocationsList();
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FutureBuilder<List<Governorate>>(
            future:
                dropDownLocations, // your async method that returns a future
              ...
              if (snapshot.hasData) {
                ...
                return DropdownButton(
                    ...
                    onChanged: (Governorate? value) {
                      ...
                      setState(() {
                        dropDownValue1Location = value?.governorateId;
